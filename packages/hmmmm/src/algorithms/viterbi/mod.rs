...
/// Finds the maximum a posteriori probability (MAP) estimate of a given sequence of observations
///
/// #### Example:
///
/// ```rust
...
/// enum Condition { Healthy, Fever }
///
/// #[repr(u8)]
/// #[derive(Observation)]
/// enum Feeling { Normal, Cold, Dizzy }
///
/// fn main () {
...
///   let (probability, sequence) = hmm.map_estimate::<Viterbi>(&signal);
///
///   assert_eq!(probability.floor(), -7.0);
///   assert_eq!(sequence, vec![Condition::Healthy, Condition::Healthy, Condition::Fever]);
/// }
/// ```
pub struct Viterbi;
